        ...
        <Box sx={{ height: '100%', boxSizing: 'border-box', display: 'flex', }}>
          ...
          <Box sx={{ height: '100%', px: 1, width: '50%', boxSizing: 'border-box', flex: '1 0 0', pt: 8, display: 'flex', flexDirection: 'column' }}>
            <Box sx={{ display: 'flex', boxSizing: 'border-box', }}>
              ...
              <Box component='span' sx={{ paddingTop: '11px', color: 'red', pl: 1, typography: 'h5', display: 'inline-block' }} >
                Assigned To Me
             ...
             <Box component='h2' sx={{typography: 'h4',textAlign:'center',color:'#797775'}}>Task assigned to me <br/> show here</Box>
